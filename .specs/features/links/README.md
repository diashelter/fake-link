...
**Status do módulo:** Em progresso — 2026-09-18 (13 fatias; 1–5 implementadas e verificadas; 6 com spec/design/tasks; 7–13 em seed)
...
2. Cada pasta começa com `spec.md`. Fatias 1–5 já têm spec fechada, design/tasks quando aplicável, Execute e `validation.md`. A fatia 6 (`link-queries`) tem spec/design/tasks; fatias 7–13 permanecem em seed.
...
| 6 | Consultas de link | [link-queries](./link-queries/spec.md) | Spec, Design e Tasks (pronta para Execute) | link-creation | `GET /api/v1/links`, `GET /api/v1/links/{link}` |
