...
**Status do módulo:** Em progresso — 2026-09-18 (13 fatias; 1–4 implementadas e verificadas; 5 especificada, com design/tasks draft; 6–13 em seed)
...
2. Cada pasta começa com `spec.md`. Fatias 1–4 já têm spec fechada, design/tasks quando aplicável, Execute e `validation.md`; a fatia 5 tem spec, design e tasks aprovadas e está pronta para Execute. Fatias 6–13 permanecem em seed.
...
| 5 | Idempotência | [idempotency](./idempotency/spec.md) | Spec, Design e Tasks aprovadas | link-creation | `Idempotency-Key`, replay cifrado, `409` |
