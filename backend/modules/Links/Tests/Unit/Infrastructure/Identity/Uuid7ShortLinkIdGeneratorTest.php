...
describe('Uuid7ShortLinkIdGenerator', function () {
    it('generates a valid uuid v7 short link id', function () {
        $generator = new Uuid7ShortLinkIdGenerator;
    ...
    it('generates temporally ordered ids', function () {
        ...
        // UUID v7 is time-ordered: lexicographic order reflects creation order
