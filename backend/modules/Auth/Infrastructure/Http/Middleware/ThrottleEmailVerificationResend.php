...
final class ThrottleEmailVerificationResend
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $key = $this->keyFactory->forEmailVerificationResend($principal->userId());
        $maxAttempts = (int) config('auth.rate_limits.email_verification_resend.max_attempts', 3);
        $decaySeconds = (int) config('auth.rate_limits.email_verification_resend.decay_seconds', 3600);
